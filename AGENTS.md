...
- Keep fees transparent and low (fixed **1,000 sat** fee; minimum payment **2,000 sats**).
...
- Fee model consistency (1,000 sat fee, 2,000 sat minimum) across client, backend, docs, and examples.
...
3. Fee path: 1,000 sats fee configuration still makes sense.
...
- Fixed fee: **1,000 sats** per payment (env overrides may exist: `FEE_AMOUNT_SATS`, `FEE_SATS`).
