...
| **ABT-L402-015** | L402 nostr npub-decode | NIP-19 bech32; nsec rejected | Mac `l402_pay.py --price 100 --method POST` |
| **ABT-L402-016** | L402 nostr zap-receipt-inspect | NIP-57 kind 9735; bolt11 amount; no invoice echo | Mac `l402_pay.py --price 100 --method POST` |
