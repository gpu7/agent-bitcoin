...
- Have a peer pay your invoice, or pay a peer invoice (amount ≥ `MIN_PAYMENT_SATS`, default 100).
...
- Amount ≥ `MIN_PAYMENT_SATS` (default **100**)
...
- Payer has enough **local** channel balance (amount ≥ `MIN_PAYMENT_SATS`, default 100)
