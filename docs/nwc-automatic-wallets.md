...
- Regtest end-to-end: `make_invoice` + `pay_invoice` ≥ `MIN_PAYMENT_SATS` (100 requested; BOLT11 is **X**).
...
| Min amount | `MIN_PAYMENT_SATS` / `NWC_MIN_PAYMENT_SATS` | default 100 |
...
| Min pay | **100 sats** requested (BOLT11 **X**) |
