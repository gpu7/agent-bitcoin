...
| Min payment (product default) | **100 sats** | Pilot pays used 2k |
...
| Nostr NWC / production swarm (M3) | **M3 v1 primitives** (2026-08-12); N6 invoice PASS; `--pay`/autopay still off | [m3-production-swarm.md](./m3-production-swarm.md) · NWC invoice hash `7afc7a2b…` |
