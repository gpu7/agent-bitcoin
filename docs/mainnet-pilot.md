...
| Nostr NWC / production swarm (M3) | **N6 invoice smoke PASS** (2026-08-12 AWS); **closed** at invoice-only | Max 2k; hash `7afc7a2b…28e6`; no `--pay`; latches off — [nwc-automatic-wallets.md](./nwc-automatic-wallets.md) |
