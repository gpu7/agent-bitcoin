...
- Optional **Aperture L402** HTTP gateway (Mac pays AWS `:8081`) including paid on-chain fee bands, mempool fullness, fee-for-vsize, confirm-target, a BTC/USD pass-through, and a Lightning path-fee hint — [docs/l402-aperture.md](docs/l402-aperture.md)
