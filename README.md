...
- Optional **Aperture L402** HTTP gateway (Mac pays AWS `:8081`) including paid on-chain fee bands at `/paid/finance/mempool-feerate` — [docs/l402-aperture.md](docs/l402-aperture.md)
