...
- Optional **Aperture L402** HTTP gateway (Mac pays AWS `:8081`) including paid on-chain fee bands (`/paid/finance/mempool-feerate`) and mempool fullness (`/paid/finance/mempool-backlog`) — [docs/l402-aperture.md](docs/l402-aperture.md)
